...
console.log(Atomics.store(ta, 0, Infinity));
console.log(Atomics.load(ta, 0));
console.log(Atomics.store(ta, 0, 2 ** 63));
console.log(Atomics.load(ta, 0));
console.log(Atomics.store(ta, 0, NaN));
console.log(Atomics.load(ta, 0));
console.log(Atomics.store(ta, 0, 1.9));
console.log(Atomics.load(ta, 0));
console.log(1 / Atomics.store(ta, 0, -0));
