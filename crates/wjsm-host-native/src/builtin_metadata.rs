...
fn binary_data_metadata(builtin: Builtin) -> Option<(&'static str, u32)> {
    Some(match builtin {
        ...
        Builtin::ArrayBufferProtoResize => ("resize", 1),
        Builtin::ArrayBufferProtoTransfer => ("transfer", 0),
        Builtin::ArrayBufferProtoTransferToFixedLength => ("transferToFixedLength", 0),
        Builtin::ArrayBufferProtoResizable => ("get resizable", 0),
        Builtin::ArrayBufferProtoMaxByteLength => ("get maxByteLength", 0),
        Builtin::ArrayBufferProtoDetached => ("get detached", 0),
