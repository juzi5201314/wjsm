...
use crate::heap::{
    Allocation, AllocatorError, GrowableHeapMemory, HandleGeneration, HandleId, HandleTableV2,
    ManagedHeap, ManagedHeapLayout, Nlab,
};
use crate::telemetry::{GcTelemetry, GcTelemetrySnapshot};
use crate::worker::{GcPacketKind, GcWorkPacket, GcWorkerPool};
...
pub struct G1V2<M: GrowableHeapMemory> {
    heap: ManagedHeap<M>,
...
impl<M: GrowableHeapMemory + Clone + 'static> G1V2<M> {
    pub fn new(
        memory: M,
