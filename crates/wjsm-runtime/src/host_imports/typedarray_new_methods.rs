...
pub(crate) fn define_typedarray_new_methods(
    ...
    linker.define(
        ...
        typedarray_proto_reduce_right_fn,
    )?;
    ...
    linker.define(
        ...
        typedarray_proto_find_index_fn,
    )?;
