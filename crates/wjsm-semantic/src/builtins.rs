...
pub(crate) fn builtin_from_string_proto_method(name: &str) -> Option<Builtin> {
    ...
    match name {
        ...
        "normalize" => Some(StringNormalize),
...
pub(crate) fn builtin_call_signature(builtin: Builtin) -> (&'static str, usize) {
    match builtin {
        ...
        Builtin::CjsCreateRequire => ("cjs.create_require", 1),
        Builtin::CjsRegisterModule => ("cjs.register_module", 3),
        Builtin::DynamicImport => ("dynamic_import", 1),
        Builtin::DynamicImportRuntime => ("dynamic_import_runtime", 2),
        Builtin::ImportMetaResolve => ("import_meta.resolve", 1),
        ...
        Builtin::ObjectHasOwn => ("Object.hasOwn", 2),
        Builtin::ObjectFreeze => ("Object.freeze", 1),
        Builtin::ObjectSeal => ("Object.seal", 1),
        Builtin::ObjectIsFrozen => ("Object.isFrozen", 1),
        Builtin::ObjectIsSealed => ("Object.isSealed", 1),
        Builtin::ObjectIsExtensible => ("Object.isExtensible", 1),
        Builtin::ObjectFromEntries => ("Object.fromEntries", 1),
        Builtin::ObjectGetOwnPropertyDescriptors => ("Object.getOwnPropertyDescriptors", 1),
        Builtin::ObjectDefineProperties => ("Object.defineProperties", 2),
        Builtin::ObjectPreventExtensions => ("Object.preventExtensions", 1),
        Builtin::ObjectGroupBy => ("Object.groupBy", 2),
        Builtin::MapGroupBy => ("Map.groupBy", 2),
        // ── BigInt builtins ──
        ...
        Builtin::StringNormalize => ("String.prototype.normalize", 2),
