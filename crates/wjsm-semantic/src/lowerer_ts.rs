...
impl Lowerer {
    pub(crate) fn lower_ts_enum(
        ...
        for member in &ts_enum.members {
            ...
            let key_const = self
                .module
                .add_constant(Constant::String(member_name.clone()));
    ...
    pub(crate) fn emit_enum_reverse_mapping(
        ...
        let rev_key_const = self
            .module
            .add_constant(Constant::String(num_str.to_string()));
        ...
        let rev_val_const = self
            .module
            .add_constant(Constant::String(member_name.to_string()));
    ...
    pub(crate) fn emit_using_disposal(&mut self, block: BasicBlockId) -> BasicBlockId {
        ...
        for var in vars.iter().rev() {
            ...
            let symbol_idx = if var.is_async {
                WK_SYMBOL_ASYNC_DISPOSE
            } else {
                WK_SYMBOL_DISPOSE
            };
            let symbol_const = self
                .module
                .add_constant(Constant::Number(symbol_idx as f64));
