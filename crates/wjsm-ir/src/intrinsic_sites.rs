...
pub const GLOBAL_IDENT_SITES: &[(&str, Builtin)] = &[
    ...
    ("FinalizationRegistry", Builtin::FinalizationRegistryConstructor),
...
pub const STATIC_MEMBER_SITES: &[(&str, &str, Builtin)] = &[
    ...
    ("Object", "getOwnPropertyDescriptor", Builtin::GetOwnPropDesc),
    ...
    ("Object", "getOwnPropertyNames", Builtin::ObjectGetOwnPropertyNames),
    (
        "Object",
    ...
    ("Object", "defineProperties", Builtin::ObjectDefineProperties),
    ("Object", "preventExtensions", Builtin::ObjectPreventExtensions),
    ...
    ("Reflect", "preventExtensions", Builtin::ReflectPreventExtensions),
    (
        "Reflect",
    ...
    ("Atomics", "compareExchange", Builtin::AtomicsCompareExchange),
